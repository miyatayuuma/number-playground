...
.manual-panel{display:grid;gap:6px;min-width:0}.manual-card-row{min-width:0}.manual-command-row{display:grid;grid-template-columns:minmax(0,1fr) 78px;gap:6px;min-width:0}
.manual-card{width:100%;min-width:0;height:58px;min-height:58px!important;display:flex;align-items:center;justify-content:center;padding:0!important;cursor:grab;overflow:hidden}.manual-card.empty{color:#718097;font-size:13px;letter-spacing:.12em;cursor:default}.manual-card.bad{animation:inputShake .28s ease;border-color:#ff7079;box-shadow:0 0 0 3px #ff707914}.manual-card.prime{border-color:#776429;background:linear-gradient(#3c3218,#211c10);color:#ffe481}.manual-card.drag{cursor:grabbing}
...
.pad-control,.digit-pad button{min-width:0;border:1px solid #34435b;border-radius:11px;background:#151e2c;color:#fff;font:inherit;font-weight:1000;touch-action:manipulation}.pad-control{height:44px;font-size:13px}.prime-select{border-color:#776429;background:#302817;color:#ffe481}.prime-select.on{box-shadow:0 0 0 2px #ffd75f55,0 0 18px #ffd75f22}.clear-select{background:#151e2c;color:#dbe5f5}
.digit-pad{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:5px;min-width:0}.digit-pad button{height:40px;font-size:18px}
...
@media(max-height:700px){body.manual-game-lock .battle.manual-mode .ez{height:138px!important}.manual-card{height:52px;min-height:52px!important}.pad-control{height:40px}.digit-pad button{height:36px}.manual-panel{gap:5px}}
@media(max-height:620px){body.manual-game-lock .hud{padding-top:3px;padding-bottom:4px}body.manual-game-lock .brand{font-size:24px}body.manual-game-lock .modes{margin-bottom:4px}body.manual-game-lock .battle.manual-mode .ez{height:118px!important}body.manual-game-lock .status{min-height:40px}.manual-card{height:46px;min-height:46px!important}.pad-control{height:36px}.digit-pad button{height:32px}.expert-bar.show{padding:5px!important}}
`;
